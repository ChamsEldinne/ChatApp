...
function ChatFooter({urlParams=null,setIstyping}) {
    ...
    const [displayButtuns,setDisplyaButtuns]=useState(true)
  ...
  return (
    <div className="chat-footer flex-none ">
        <div className="flex flex-row items-center p-4">
            ...
            <button type="button" className={`${displayButtuns?"flex":"hidden" } flex-shrink-0 focus:outline-none mx-2  text-blue-600 hover:text-blue-700 w-6 h-6`}>
                <svg viewBox="0 0 20 20" className="w-full h-full fill-current">
