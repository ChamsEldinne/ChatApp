...
function ChatHeader({reciverUser,reciverLoading,setDisplauChat ,displayedContact}) {
  return (
    <div className="chat-header border-b-2 border-gray-800 px-2 md:px-6 py-2 md:py-4 flex flex-row flex-none justify-between items-center shadow">
        <div className='flex gap-2 items-center'>
            ...
            {! reciverLoading ?
                <Reciver reciverUser={reciverUser} displayedContact={displayedContact} />:<ReciverLoading />
            }
        </div>
