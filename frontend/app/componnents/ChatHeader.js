...
function ChatHeader({reciver,isLoading}) {


 
  return (
    <div className="chat-header sticky top-0 border-b-2 border-gray-800 px-2 md:px-6 py-2 md:py-4 flex flex-row flex-none justify-between items-center shadow">
        <div className='flex gap-2 items-center'>
            <Link href={'/chat'} className='flex rounded-full text-blue-500 hover:bg-gray-700 bg-gray-800 md:hidden justify-center items-center w-10 h-10 p-1 cursor-pointer'>
                <svg width="24px" height="24px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#2563eb" d="M224 480h640a32 32 0 1 1 0 64H224a32 32 0 0 1 0-64z"></path><path fill="#2563eb" d="m237.248 512 265.408 265.344a32 32 0 0 1-45.312 45.312l-288-288a32 32 0 0 1 0-45.312l288-288a32 32 0 1 1 45.312 45.312L237.248 512z"></path></g></svg>
            </Link>
            {! isLoading && reciver ?
                <Reciver reciverUser={reciver }  />:<ReciverLoading />
            }
        </div>
       
    <div className="flex">
        
        <a href="#" className="block rounded-full hover:bg-gray-700 bg-gray-800 size-8 md:size-10 p-2">
            ...
            <a href="#" className="block rounded-full hover:bg-gray-700 bg-gray-800 size-8 md:size-10 p-2 ml-4">
                <svg viewBox="0 0 20 20" className="w-full h-full fill-current text-blue-500">
