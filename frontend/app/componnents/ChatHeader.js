  ...
  return (
    <div className="chat-header border-b-2 border-gray-800 px-2 md:px-6 py-2 md:py-4 flex flex-row flex-none justify-between items-center shadow">
        <div className='flex gap-2 items-center'>
            <div onClick={()=>{router.back()}} className='flex rounded-full text-blue-500 hover:bg-gray-700 bg-gray-800 md:hidden justify-center items-center w-10 h-10 p-1 cursor-pointer'>
