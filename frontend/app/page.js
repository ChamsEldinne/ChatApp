'use client'
import ActiveUserContainer from './componnents/ActiveUserContainer'
import ActiveUserWithStoryContainer from './componnents/ActiveUserWithStoryContainer';
import MessageContainer from './componnents/MessageContainer';
import ContactContainer from './componnents/ContactContainer';
import ContactContainer2 from './componnents/ContactContainer2';
import GroupContactContainer from './componnents/GroupContactContainer';
import SideBar from './componnents/SideBar';
import { useState } from 'react';

export default function Home() {
  const [dispalySidBar,setDispalySideBar ]=useState(true) ;

  return ( 
    <div className="h-[97vh] w-full flex antialiased text-gray-200 bg-gray-900 overflow-y-hidden">
        <div className="flex-1 flex flex-col">
         
            <main className="flex-grow flex flex-row min-h-0 relative">
                <section className="bg-gray-900 h-full absolute md:relative left-0 top-0 z-10 md:flex flex-col flex-none overflow-auto w-full lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
                    ...
                    <div className="active-users flex flex-row items-center p-2 overflow-auto w-0 min-w-full">
                        <div className="text-sm flex justify-center items-center gap-2 flex-col text-center mr-4">
                            <button className="flex flex-shrink-0 focus:outline-none  bg-gray-800 text-gray-600 rounded-full size-16"
                                    type="button">
                       ...
                       <ActiveUserContainer/>
                       <ActiveUserWithStoryContainer/>
                       <ActiveUserContainer/>
                       <ActiveUserContainer/>
                       <ActiveUserWithStoryContainer/>
                       <ActiveUserContainer/>
                    </div>
                    <div className="contacts mb-4  p-2 flex-1 overflow-y-scroll">
                        <ContactContainer/>
                        <ContactContainer2/>
                ...
                <section className="flex flex-col flex-auto border-l relative border-gray-800">
                     <div className=' md:hidden size-14 absolute left-0 top-0 '>
                        <svg width="34px" height="34px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15 1H1V3H15V1Z" fill="#2563eb"></path> <path d="M1 5H15V7H1V5Z" fill="#2563eb"></path> <path d="M15 9H1V11H15V9Z" fill="#2563eb"></path> <path d="M11 13H1V15H11V13Z" fill="#2563eb"></path> </g></svg>
                     </div>
