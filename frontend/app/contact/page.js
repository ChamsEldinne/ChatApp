...
function page() {
    ...
    useEffect(()=>{
        const fetchData=async ()=>{
            try{
                const response=await axiosClient.get('/api/broadcast')
            }catch(err){
...
<div class="flex items-center justify-center w-full h-full">
  <div class="m-2 w-full md:w-1/2 lg:3/4 border flex flex-col rounded-t-xl  h-[100vh]">
    <header class="w-full bg-blue-500 flex  justify-between px-2 py-1 rounded-t-lg items-center">
      ...
      <span class="text-white aspect-square w-8 cursor-pointer p-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#ffffff" d="M5.293 5.293a1 1 0 0 1 1.414 0L12 10.586l5.293-5.293a1 1 0 1 1 1.414 1.414L13.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414L12 13.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L10.586 12L5.293 6.707a1 1 0 0 1 0-1.414"/></svg></span>
    </header>

    <div class="flex flex-col gap-4 p-2 select-none overflow-y-auto h-[80vh]">
    ...
    <div class="flex items-center my-2 mx-1">
      ...
      <button type="submit" class="flex justify-center items-center aspect-square h-9 bg-blue-500  p-2 text-white rounded-full cursor-pointer hover:bg-blue-700">
...
function Recived(){
    ...
    <div className="flex items-end">
        <div className="rounded bg-blue-500 w-8 aspect-square p-1.5"><svg xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24">
            <g fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
              color="#ffffff">
              <path d="M4 15.5a2 2 0 1 1 0-4m16 4a2 2 0 1 0 0-4M7 7V4m10 3V4" />
