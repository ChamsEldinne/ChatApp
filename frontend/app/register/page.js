...
function page() {
    const[input,setInput]=useState({email:"",password:"",password_confirmation:"",name:""})
    const[errors,setErrors]=useState({name:null,email:null,password:null,password_confirmation:null,first_name:null,last_name:null})
 ...
 <div className='bg-gray-900 h-full w-full  flex justify-center items-center'>
    ...
    <div className="mb-5">
        <label for="name" className="block mb-2 text-sm font-medium text-gray-200">Your Name</label>
        <input type="text" id="name" value={input.name} onChange={(e)=>handelChange(e)}  className="shadow-sm  border   text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-gray-200 focus:ring-blue-500 focus:border-blue-500  outline-none shadow-sm-light" placeholder="name@flowbite.com" required />
    ...
    <div className="mb-5">
        <label for="password_confirmation" className="block mb-2 text-sm font-medium text-gray-200">Confirm Password</label>
        <input type="password" id="password_confirmation" value={input.password_confirmation} onChange={(e)=>handelChange(e)} className="shadow-sm  border   text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-gray-200 focus:ring-blue-500 focus:border-blue-500  outline-none shadow-sm-light" placeholder="name@flowbite.com" required />
    ...
    <button onClick={(e)=>register(e)} type="submit" className="text-gray-200 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">{loading?"Registraion...": "Register Your acount"}</button>
